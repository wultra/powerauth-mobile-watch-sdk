...
We still maintain the documentation for the library at the original location, so, if you looking for a documentation, then we recommend you to visit our [documentation portal](https://developers.wultra.com/components/powerauth-mobile-sdk/develop/documentation/PowerAuth-SDK-for-watchOS).